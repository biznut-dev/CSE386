...
void func9() {
	square(1.0, 1.0, -3.0, red, 1.0);
	square(0.0, 0.0, -2.0, cyan);
	square(0.0, 0.0, -2.0, magenta, 0.25);
	square(-1.0, -1.0, -1.0, green, 1.0);
}
void func10() {
	square(1.0, 1.0, -3.0, red, 1.0);		// behind of decal
	square(-1.0, -1.0, -1.0, green, 1.0);	// in front of decal

	FragmentOps::readonlyDepthBuffer = true;
	square(0.0, 0.0, -2.0, cyan);			// base
	square(0.0, 0.0, -2.0, magenta, 0.25);	// decal
